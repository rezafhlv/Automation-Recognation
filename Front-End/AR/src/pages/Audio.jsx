...
const AutomationRecognitionPage = () => {
  ...
  const audioMap = {
    ...
    langet: "../assets/audio/langet_andra.wav",
    pakri: "../assets/audio/pakri_reja.wav",
    saleum: "../assets/audio/saleum_reja.wav",
    uroe: "../assets/audio/uroe_reja.wav",
    terimonggeunaseh: "../assets/audio/terimonggeunaseh_reja.wav",
    tanoh: "../assets/audio/tanoh_reja.wav",
    singoh: "../assets/audio/singoh_faiz.wav",
    bagah: "../assets/audio/bagah_faiz.wav",
    bulut: "../assets/audio/bulut_faiz.wav",
    kuto: "../assets/audio/kuto_faiz.wav",
    grah: "../assets/audio/grah_faiz.wav",
    rumoh: "../assets/audio/rumoh_dek_wah.wav",
    sampoh: "../assets/audio/sampoh_dek_wah.wav",
    sira: "../assets/audio/sira_dek_wah.wav",
    sihat: "../assets/audio/sihat_dek_wah.wav",
    ujeun: "../assets/audio/ujeun_dek_wah.wav",
  };
